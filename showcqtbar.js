...
function _init(i1, i3, i4, f5, f6, i10) {
 ...
 f6 = Math_fround(f6);
 i10 = i10 | 0;
 var d2 = 0.0, i7 = 0, d8 = 0.0, d9 = 0.0, d11 = 0.0, i12 = 0, i13 = 0, d14 = 0.0, d15 = 0.0, d16 = 0.0, d17 = 0.0, d18 = 0.0, i19 = 0, d20 = 0.0;
 ...
 d20 = +(i1 | 0);
 i1 = ~~+Math_ceil(+(+Math_log(+(d20 * .33)) / .6931471805599453));
 if ((i1 + -10 | 0) >>> 0 > 10) {
  i19 = 0;
  return i19 | 0;
 }
 ...
 if ((i19 | 0) != 31) {
  ...
  i1 = 0;
  do {
   i19 = i1 << 1 & -1431655766 | i1 >>> 1 & 1431655765;
   i19 = i19 << 2 & -858993460 | i19 >>> 2 & 858993459;
   i19 = i19 << 4 & -252645136 | i19 >>> 4 & 252645135;
   i19 = i19 << 8 & -16711936 | i19 >>> 8 & 16711935;
   HEAP32[532348 + (i1 << 2) >> 2] = (i19 << 16 | i19 >>> 16) >>> i3 & i4;
   i1 = i1 + 1 | 0;
  } while ((i1 | 0) < (i7 | 0));
  i3 = HEAP32[248673] | 0;
 }
  ...
  do {
   ...
   if ((i4 | 0) > 0) {
    ...
    do {
     i19 = i1 + i4 | 0;
     d18 = d2 * +(i1 | 0);
     f6 = Math_fround(-Math_fround(+Math_sin(+d18)));
     HEAPF32[270204 + (i19 << 3) >> 2] = Math_fround(+Math_cos(+d18));
     HEAPF32[270204 + (i19 << 3) + 4 >> 2] = f6;
     i1 = i1 + 1 | 0;
    } while ((i1 | 0) != (i4 | 0));
   }
   i4 = i4 << 1;
 ...
 if ((i19 | 0) > 0) {
  i1 = 0;
  do {
   d18 = +(i1 | 0) * 3.141592653589793 / d2;
   HEAPF32[597884 + (i1 << 2) >> 2] = Math_fround(+Math_cos(+d18) * .487396 + .355768 + +Math_cos(+(d18 * 2.0)) * .144232 + +Math_cos(+(d18 * 3.0)) * .012604);
   i1 = i1 + 1 | 0;
  } while ((i1 | 0) < (HEAP32[248675] | 0));
 }
 i13 = Math_imul(HEAP32[248671] | 0, i10 | 0 ? 2 : 1) | 0;
 HEAP32[248674] = i13;
 if ((i13 | 0) <= 0) {
  i19 = HEAP32[248673] | 0;
  return i19 | 0;
 ...
 i19 = 0;
 while (1) {
  d8 = +Math_exp(+((+(i7 | 0) + .5) * 6.931471805599452 * d18 + 2.9964935469158838));
  if (d8 >= d14) {
   i3 = 20;
   break;
  }
  d2 = d8 * .33;
  d2 = d16 / (d20 * (126.72 / (d2 / .83 + 2258.8235294117644) + 126.72 / (d2 / .17 + 462.65060240963857)));
  d11 = d8 * d15 / d20;
  d9 = d2 * .5;
  i3 = ~~+Math_ceil(+(d11 - d9));
  i10 = ~~+Math_floor(+(d11 + d9));
  i12 = i10 - i3 | 0;
  i4 = i12 + 1 | 0;
  if ((i19 + 1e3 + i4 | 0) > 2e5) {
   i1 = 0;
  ...
  HEAP32[994712 + (i19 << 2) >> 2] = i4;
  HEAP32[994712 + (i19 + 1 << 2) >> 2] = i3;
  if ((i10 | 0) >= (i3 | 0)) {
   d9 = 1.0 / d2;
   d2 = d8 * d8;
   d2 = d8 * d2 * 14884.0e4 / ((d2 + 424.36000000000007) * (d2 + 14884.0e4) * +Math_sqrt(+(d2 + 25122.25)));
   i4 = i19 + 2 - i3 | 0;
   while (1) {
    d8 = d9 * ((+(i3 | 0) - d11) * 6.283185307179586);
    HEAPF32[994712 + (i4 + i3 << 2) >> 2] = Math_fround((+Math_cos(+d8) * .487396 + .355768 + +Math_cos(+(d8 * 2.0)) * .144232 + +Math_cos(+(d8 * 3.0)) * .012604) * (+((i3 << 1 & 2 ^ 2) + -1 | 0) * d17 * d2));
  ...
  if ((i7 | 0) >= (i13 | 0)) {
   i3 = 26;
   break;
  } else i19 = i19 + 3 + i12 | 0;
 }
 if ((i3 | 0) == 20) {
  HEAP32[994712 + (i19 << 2) >> 2] = 0;
  i19 = i1;
  return i19 | 0;
